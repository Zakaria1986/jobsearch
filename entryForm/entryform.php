  ...
  <div class="row justify-content-md-center">
        <form action="inc/insertinto.php" method="POST">
            <div class="mb-3 col-6">
                ...
                <input  type="text" name='job_title' class="form-control" id="exampleInputEmail1" aria-describedby="enter email address" required>
                <div id="emailHelp" class="form-text"></div>
            </div>
            <div class="mb-3 col-3">
                <label for="taxChoice" class="form-label">Taxonomy</label>
                <select name="status" id="status" list="status taxChoice" name="status" class="form-control"  aria-describedby="Satus application in" required>
                        <?php  taxonomyResult(); ?>
                </select>
                <div id="emailHelp" class="form-text"></div>
            </div>
            <div class="mb-6 col-6">
                ...
                <input type="text" class="form-control" name='url' id="url" aria-describedby="enter email address" required>
                <div id="emailHelp" class="form-text">Job url</div>
            </div>
            <div class="mb-3 col-8">
                <label for="coverletterno " class="form-label">Cover letter</label>
                <textarea type="textarea" name='description' class="form-control " id="coverletter" required></textarea>
            </div>
