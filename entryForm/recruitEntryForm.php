  ...
  <div class="row alert alert-light ">
        <form class='recruiters' action="../inc/recrinsert.php" method="POST">
            <div class="mb-3 col-6">
                ...
                <input type="text" name='recruiter_name' class="form-control" id="recruiter_name" aria-describedby="Recruiters name" required>
                <div id="recruiter_name" class="form-text"></div>
            </div>
            <div class="mb-6 col-6">
                <label for="website" class="form-label">Job board</label>
                <input type="text" class="form-control" name='website' id="website" aria-describedby="Enter website url" required>
                <div id="websiteHelper" class="form-text">Website</div>
            </div>
            <div class="mb-3 col-8">
                <label for="comments" class="form-label">Comments</label>
                <textarea type="textarea" name='comments' class="form-control " id="comments" required></textarea>
            </div>
